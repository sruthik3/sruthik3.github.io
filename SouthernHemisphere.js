   ...
   /* g.append("path")
    ...
    ////////////////
            ...
            
          {
            ...
            subject: { radius: 8 },
            data: { x: "1/30/1940", y: 0.15 },
            dy: -80
          },


          {
            note: { label: "Peak rise of 0.77 degree Celsius", 
              lineType:"none", 
              orientation: "top",
              "padding": 2, 
              "align": "middle" },
...
plotChart("https://sruthik3.github.io/Southern_Hemisphere_Temp.csv","area");